package TJRiker.WGUScheduler.data;
...
public class DBHelper extends SQLiteOpenHelper {
    private static final String DATABASE = "wguDatabase.db";
    ...
    private static final String DATABASE_CREATE_COURSE = "CREATE TABLE "
            ...
            + CourseData.COLUMN_START_ID + " INTEGER NOT NULL, "
            + CourseData.COLUMN_END_ID + " INTEGER NOT NULL, "
    ...
    private static final String DATABASE_CREATE_ASSESSMENT = "CREATE TABLE "
            ...
            + AssessmentData.COLUMN_DUE_DATE + " INTEGER NOT NULL, "
            + AssessmentData.COLUMN_COURSE_ID + " INTEGER NOT NULL, "
            + AssessmentData.COLUMN_DUE_DATE_ID + " INTEGER NOT NULL, "
